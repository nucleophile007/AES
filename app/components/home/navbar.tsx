  ...
  return (
    <div className={cn("relative", className)}>
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={null} item="Our Team" href="/our-team" className="text-yellow-400/90 hover:text-yellow-300 transition-colors font-medium">
        </MenuItem>
        ...
        <MenuItem setActive={setActive} active={null} item="AES Creatorverse" href="/aes-creatorverse" className="text-yellow-400/90 hover:text-yellow-300 transition-colors font-medium">
          {/* <div className="text-sm grid grid-cols-1 gap-4 p-6 min-w-[300px] bg-gradient-to-br from-[#1a2236] to-[#1d2a45]">
            <ProductItem
