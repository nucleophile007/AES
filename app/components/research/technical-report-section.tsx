    ...
    <div className="bg-slate-800 border border-slate-700 rounded-2xl overflow-hidden">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6 md:p-8 space-y-5">
          <div>
            <h3 className="text-xl font-semibold theme-text-light mb-2">
              Full Technical Report (PDF)
            </h3>
            <p className="theme-text-muted leading-relaxed">
              Access the complete written research report including
              methodology, literature review, experimental design,
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-2 p-3 bg-slate-900/30 rounded-lg"
              >
