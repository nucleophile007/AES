...
type Item = { id: number; teacherFinalText: string; approvedAt: string; student: { name: string }; meeting: { title: string; startDateTime: string; teacher: { name: string } } };
const HIDDEN_KEY = 'aes:parent:hidden-meeting-minutes';
export default function ParentMeetingMinutes() {
