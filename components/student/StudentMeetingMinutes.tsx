...
type Item = { id: number; status: 'ASSIGNED' | 'SUBMITTED' | 'APPROVED'; studentMinutes: string | null; teacherFinalText: string | null; meeting: { title: string; startDateTime: string; teacher: { name: string } } };
